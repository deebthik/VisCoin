...
predict = dlib.shape_predictor("/Users/deebthik/Desktop/hackathon_files/Viscoin/shape_predictor_68_face_landmarks.dat")# Dat file is the crux of the code
...
while overall_count < toj*7:
	...
	cv2.putText(frame, str(float(ewma)), (600, 350),
